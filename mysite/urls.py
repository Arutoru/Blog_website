...
urlpatterns = [
    ...
    # En utilisant LoginView il est possible de définir des actions selon que l'utilisateur est connecté ou pas
    # Il faut noter que le login est fait uniquement si le formulaire de login.html est valide
